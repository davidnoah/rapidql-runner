...
export default {
  ...
  toggle() {
    let options = JSON.parse(fs.readFileSync('../samples/options.rql', "utf8"));
    let query = fs.readFileSync('../samples/query.rql', "utf8");
    let context = JSON.parse(fs.readFileSync('../samples/context.rql', "utf8"));
